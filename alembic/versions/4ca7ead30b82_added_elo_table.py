...
Revision ID: 4ca7ead30b82
Revises: fabe363bf0ab
Create Date: 2024-10-25 21:25:24.358144
...
revision: str = '4ca7ead30b82'
down_revision: Union[str, None] = 'fabe363bf0ab'
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['driver_id'], ['tsu.drivers.id'], name=op.f('fk_elo_driver_id_drivers')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_elo')),
    schema='tsu'
    )
